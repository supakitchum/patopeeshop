<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <div class="text-center pb-1">
            <img class="mt-5" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Logo_TV_2015.svg/1200px-Logo_TV_2015.svg.png" style="height: 5rem;">
        </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ Request::is('*products') ? 'menu-open':'' }}">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('backend.products.index') }}"><i class="fa fa-circle-o"></i> จัดการสินค้า</a></li>
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('backend.payments.create') }}"><i class="fa fa-plus-circle"></i> เพิ่มรายการแจ้งชำระ</a></li>
                </ul>
            </li>
            <li>
